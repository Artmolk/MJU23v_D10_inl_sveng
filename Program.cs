...
namespace MJU23v_D10_inl_sveng
{
    ...
    internal class Program
    {
        ...
        static void Help(TextWriter output)
        {
        ...
        static void LoadCommand(string[] arguments, string defaultFile)
        {
            string fileName = arguments.Length == 2 ? arguments[1] : defaultFile;
            LoadDictionary(@"C:\Users\A.T\Desktop\Mölk\Sveng\MJU23v_D10_inl
            Sveng\MJU23v_D10_inl_sveng\dict\computing.lis"");
}
    static void ListCommand(TextWriter output)
    {
    ...
    static void DeleteCommand(string[] arguments, TextWriter output)
    {
    ...
    static void NewCommand(string[] arguments, TextWriter output)
    {
        if (arguments.Length == 3)
        {
            string swedishWord = arguments[1];
    ...
    static void Run(TextReader input, TextWriter output, string defaultFile)
    {
        ...
        while (true)
        {
            ...
            {
                LoadCommand(arguments, defaultFile);
            }
            ...
            {
                DeleteCommand(arguments, output);
            }
            else if (command == ""new"")
            {
                NewCommand(arguments, output);
            }
            else
            {
    ...
    static void Main(string[] args)
    {
        ...
        Run(Console.In, Console.Out, DefaultFile); // Använder konstant här
    }
